	...
	protected class ClientSessionHandler extends IoHandlerAdapter {
		...
		public void messageReceived(IoSession session, Object msg) throws Exception {
			if (msg instanceof DispatchPacket) {
				...
				int sessionId = (Integer) session.getAttribute(SESSION_ID); // �����dispatch��proxy���ӵ�Id��ÿ��һ��proxy����1
				ClientSession cs = getSession(sessionId);
				if (cs == null) {
					sessionId = id_gen.incrementAndGet(); // �����ClientSessionȫ��Ψһ�ı�ǣ����е�ClientSession����������ν����ģ�����һ��Ψһ��Id
